...
This is the Vivijure MuseTalk lip-sync module, a MuseTalk-based finish container, invoked by the Vivijure studio and its render backend (the trusted control plane). It
