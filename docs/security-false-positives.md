...
| 2026-07-24 | K2.7 PR #76 (#67) | ffmpeg silencedetect on job audio_key | Operator-supplied dialogue WAV from the render chain; local path only; no URL fetch; bounds rest-hold |
